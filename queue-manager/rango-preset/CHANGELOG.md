# [0.28.0](https://github.com/nikaaru/rango-client/compare/queue-manager-rango-preset@0.27.0...queue-manager-rango-preset@0.28.0) (2025-08-03)
...
* a bug in updateHash ([9ce8ccb](https://github.com/nikaaru/rango-client/commit/9ce8ccb9c3c3a8fc4277a876515c6ee16c4afe9a))
...
* add wallets-core to rango-preset package dependencies ([b9700ca](https://github.com/nikaaru/rango-client/commit/b9700ca160ace208027055f3a3e9b6eb47907647))
* avoid getting transaction receipt multiple times ([2369e06](https://github.com/nikaaru/rango-client/commit/2369e067e165c53e5791dec8ef0df60c70a89d60))
...
* display correct network in switch network modal ([4494f3c](https://github.com/nikaaru/rango-client/commit/4494f3c96bffe6f26cf31e19f0ca7e6be3a38e81))
...
* fix flow bug when check status failed ([66ba427](https://github.com/nikaaru/rango-client/commit/66ba42701b83a897aab9695a359c587f4e486e37))
...
* getChainId & networkMatched on wallet connect v1 ([c2e8a29](https://github.com/nikaaru/rango-client/commit/c2e8a29299e268f59f2cef781936fa8f36f35bcc))
* handle replaced transactions ([092f4ef](https://github.com/nikaaru/rango-client/commit/092f4efcd0468d25df13fe2d0e1aecac54c7141e))
* increase approval checking interval ([2d77521](https://github.com/nikaaru/rango-client/commit/2d77521cd604e5f374155f947ccb44301cd85f2f))
...
* show network name instead of namespace ([0853c27](https://github.com/nikaaru/rango-client/commit/0853c2771c9310a01ee617baec9520c7e5ea12d3))
* showing correct network in notification ([c540ef0](https://github.com/nikaaru/rango-client/commit/c540ef041262337dc5a06d66993b37abe99c4b50))
...
* add Ton Transaction and integrate MyTonWallet ([16c81c3](https://github.com/nikaaru/rango-client/commit/16c81c31e1474f55aedeeff3f8a46be74b9f9cba))
...
* update payload for events ([b3b8706](https://github.com/nikaaru/rango-client/commit/b3b8706195d7d83aab7ca38e66ceb0e1c72fa2cc))
...
* update the event payload for failed step and failed route events ([bc1d759](https://github.com/nikaaru/rango-client/commit/bc1d7590eaccc57cf680ceb40a53075c8a6eb174))
