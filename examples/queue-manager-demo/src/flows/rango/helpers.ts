...
import { SUPPORTED_ETH_CHAINS as XDEFI_WALLET_SUPPORTED_EVM_CHAINS } from '@nikaru-dev/provider-xdefi/src/constants';
import { readAccountAddress } from '@nikaru-dev/wallets-react';
import {
  Networks,
  WalletTypes,
