...
import type Wallet from '@nikaru-dev/wallets-core';
import type {
  Options,
  EventHandler as WalletEventHandler,
  State as WalletState,
} from '@nikaru-dev/wallets-core';
import type { WalletConfig, WalletType } from '@nikaru-dev/wallets-shared';

import { Persistor } from '@nikaru-dev/wallets-core';
